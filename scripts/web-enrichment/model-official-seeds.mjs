import { todayInZone } from '../shared.mjs';

export const MODEL_REPORT_DATE = process.env.MODEL_REPORT_DATE
  || process.env.REPORT_DATE
  || todayInZone(process.env.REPORT_TZ || 'Asia/Shanghai');
...
export const MODEL_OFFICIAL_SOURCES = [
  ...
  { provider: 'Anthropic', title: 'Claude Fable 5 and Mythos 5 announcement', url: 'https://www.anthropic.com/news/claude-fable-5-mythos-5', kind: 'official_announcement' },
  { provider: 'Anthropic', title: 'Anthropic statement on government order', url: 'https://www.anthropic.com/news/statement-on-us-government-order-limiting-foreign-access', kind: 'official_statement' },
  ...
  { provider: 'Anthropic', title: 'Introducing Claude Opus 4.8', url: 'https://www.anthropic.com/news/claude-opus-4-8', kind: 'official_announcement' },
...
export const MODEL_VERIFIED_SEEDS = [
  ...
  },
  {
    ...
    modalities: ['text', 'image'],
    key_capabilities: 'Anthropic 旗舰级通用与长上下文模型，强调科学研究、工程与企业复杂任务。',
    api_pricing: usdPricing('10.00', '1.00', '50.00', 'https://platform.claude.com/docs/en/about-claude/pricing'),
    status: 'access_suspended',
    next_model_info: '2026-06-12 因美国政府限制外国访问指令暂停开放，后续等待官方恢复说明。',
    source_title: 'Claude Fable 5 and Mythos 5 announcement',
  ...
  },
  {
    ...
    context_window: '1M tokens',
    modalities: ['text', 'image'],
    key_capabilities: 'Anthropic 面向多步骤推理、创意与代理任务的前沿模型，定价与 Fable 5 同档。',
    api_pricing: usdPricing('10.00', '1.00', '50.00', 'https://platform.claude.com/docs/en/about-claude/pricing'),
    status: 'access_suspended',
    next_model_info: '2026-06-12 因美国政府限制外国访问指令暂停开放，后续等待官方恢复说明。',
    source_title: 'Claude Fable 5 and Mythos 5 announcement',
  ...
  },
  {
    ...
    status: 'active',
    next_model_info: 'Fable 5 / Mythos 5 发布后作为 4.x 旗舰线继续保留兼容观察。',
    source_title: 'Introducing Claude Opus 4.8',
...
export const MODEL_TIMELINE_SEEDS = [
  ...
  timelineRow({
    ...
    model: 'Claude 5访问暂停',
    type: '生命周期变更',
    summary: '美国政府限制外国访问后，Anthropic 暂停两款 5 代模型开放。',
    pricing: usdPricing('10.00', '1.00', '50.00', 'https://platform.claude.com/docs/en/about-claude/pricing'),
    confidence: 'high',
    dateConfidence: 'exact',
    sourceTitle: 'Anthropic statement on government order',
    sourceUrl: 'https://www.anthropic.com/news/statement-on-us-government-order-limiting-foreign-access',
  }),
  timelineRow({
    date: '2026-06-09',
    provider: 'Anthropic',
    ...
    type: '旗舰模型',
    summary: '5 代前沿模型面向复杂研究、工程与代理任务，1M context。',
    pricing: usdPricing('10.00', '1.00', '50.00', 'https://platform.claude.com/docs/en/about-claude/pricing'),
    confidence: 'high',
    dateConfidence: 'exact',
    sourceTitle: 'Claude Fable 5 and Mythos 5 announcement',
  ...
  timelineRow({
    ...
    confidence: 'high',
    dateConfidence: 'exact',
    sourceTitle: 'Introducing Claude Opus 4.8',
